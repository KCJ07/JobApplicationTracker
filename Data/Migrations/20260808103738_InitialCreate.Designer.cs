...
namespace JobApplicationTracker.Migrations
{
    ...
    [Migration("20260808103738_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobApplicationTracker.Models.Application", b =>
                {
                    b.HasOne("JobApplicationTracker.Data.ApplicationUser", "ApplicationUser")
                        .WithMany("Applications")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JobApplicationTracker.Models.Job", "Job")
                        .WithMany("Applications")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
